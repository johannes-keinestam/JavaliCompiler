...
public abstract class Ast {
	...
	public static class MethodCallExpr extends Expr {
		...
		/**
		 * Updates the argument list, keeping the receiver.
		 */
		public void setArguments(List<Ast> parameters) {
			Expr receiver = receiver();
			this.rwChildren.clear();
			this.rwChildren.add(receiver);
			this.rwChildren.addAll(parameters);
		}
